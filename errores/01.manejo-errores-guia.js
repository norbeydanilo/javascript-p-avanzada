/*
 * Manejo de errores.
 * El manejo de errores con Javascript se realiza por medio de la declaración try…catch, el try es utilizado para definir un 
 * bloque de instrucciones que deben ser ejecutadas y en caso de que se presente algún error, 
 * se ejecutan las instrucciones definidas en el bloque catch.
 */
...
try {
    let numero = 'y'
    if (isNaN(numero)) { // El método isNaN() evalua si la variable es de tipo numérico o no
